...
(function () {
  ...
  /* ---------- Lightbox (any [data-lightbox] img) ---------- */
  ...
  if (PAGE === 'home') {
    ...
    sty.textContent =
      '.dir-switch{position:fixed;right:16px;bottom:16px;z-index:80;' +
      'display:flex;align-items:center;gap:5px;padding:6px 8px 6px 14px;border-radius:999px;' +
      'background:rgba(36,28,20,.92);backdrop-filter:blur(8px);box-shadow:0 14px 40px -14px rgba(0,0,0,.6);' +
      'font-family:var(--ff-mono);}' +
      '.dir-switch__lbl{font-size:9.5px;letter-spacing:.16em;text-transform:uppercase;color:#b6a98a;margin-right:4px;}' +
      '.dir-switch a{display:flex;align-items:center;justify-content:center;width:30px;height:30px;border-radius:50%;' +
      'text-decoration:none;color:#e6dcc6;font-size:13px;font-weight:500;letter-spacing:0;' +
      'transition:background .3s,color .3s;}' +
      '.dir-switch a:hover{color:#fff;background:rgba(255,255,255,.1);}' +
      '.dir-switch a.on{background:var(--rust);color:#fff;}';
